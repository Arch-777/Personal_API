...
const socialLinks = [
  ...
  { icon: Mail,     href: 'mailto:hello@personalapi.dev', label: 'Email' },
]
      ...
      <div className="max-w-6xl mx-auto px-6 mb-14">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-6">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            >
              Your Personal<br />Digital Brain.
            </p>
            ...
            >
              Connect Notion, Slack, Drive &amp; Telegram into one
          ...
          {socialLinks.map(({ icon: Icon, href, label }) => (
            <Link
              ...
              onMouseEnter={(e) => {
                ...
                el.style.borderColor = isDark ? 'rgba(255,255,255,0.18)' : 'rgba(0,0,0,0.18)'
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLElement
